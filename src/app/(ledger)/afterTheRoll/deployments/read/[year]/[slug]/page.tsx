...
<div className="mt-[1rem]"><FirebaseGuestbook collectionName={commentCollection} placeholder="이 글에 대한 말을 남겨 주세요." emptyMessage="첫 댓글을 남겨 보세요." theme="afterroll" threaded likesEnabled /></div></section></article></main>;
}
